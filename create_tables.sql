...
CREATE TABLE dim_counterparty (
    ...
    counterparty_legal_postcode VARCHAR NOT NULL,
...
CREATE TABLE fact_sales_order (
    ...
    agreed_delivery_date DATE REFERENCES dim_date(date_id) NOT NULL,
    agreed_payment_date DATE REFERENCES dim_date(date_id) NOT NULL,
